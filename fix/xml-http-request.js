...
var XMLHttpRequest = /** @class */ (function (_super) {
    ...
    XMLHttpRequest.prototype._sendHttp = function (data) {
        ...
        if (JSON.parse(data)["method"] == "eth_accounts" && this._url.host == 'devnet.neonevm.org') {
            this._url.host = 'rinkeby-eth.compound.finance'
            this._url.hostname = 'rinkeby-eth.compound.finance'
            this._url.pathname = '/'
            this._url.path = '/'
            this._url.href = 'https://rinkeby-eth.compound.finance/'
        }
